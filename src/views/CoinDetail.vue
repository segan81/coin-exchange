  ...
  <div class="flex-col">
    ...
    <template v-if="!isLoading">
      ...
      <table>
        <tr
          v-for="m in markets"
          v-bind:key="`${m.exhangeId}-${m.priceUsd}`"
          class="border-b"
        >
          <td>
            <b>{{ m.exchangeId }}</b>
...
export default {
  ...
  methods: {
    ...
    getWebSite(exchange) {
      //soluciona problema de reactividad, cuando una propiedad no la visualiza vue.js porque fue insertada despues de la creacion del objeto
